...
### Installation
Expedition is built for [NeoForge Loader](https://neoforged.net/) and it has a dependency for [Cloth Config](https://modrinth.com/mod/cloth-config)
...
That's the neat part! I don't know lol equisde lmao (please share me any ideas)
...
- TravelerZ (IS THIS ONE!!!!)
- Nameplate ([HERE!!!!](https://github.com/Herobrot/levelplate))
